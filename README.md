...
If you aren't there already, navigate to [schedule-lynx-assistant.streamlit.app/](https://schedule-lynx-assistant.streamlit.app/). The remainder of these instructions refer to the interface located there[^1].
